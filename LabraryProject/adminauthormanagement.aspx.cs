...
namespace LabraryProject
{
	...
	public partial class adminauthormanagement : System.Web.UI.Page
	{
		...
		protected void Button2_Click(object sender, EventArgs e)
		{
			...
			{
				Response.Write("<script>alert('Автор с данным номером существует, попробуйте другой');</script>");
			}
			else
			{
				addNewAuthor();
		...
		{
			GridView1.HeaderRow.Cells[0].Text = "Номер автора";
			GridView1.HeaderRow.Cells[1].Text = "Имя автора";
		}
	}
